...
Write the report to `SCANS/grant_scan_YYYY-MM-DD-NN.md` using today's date and a two-digit sequence number (NN). Check existing files in `SCANS/` for today's date and increment: `-01`, `-02`, etc.
